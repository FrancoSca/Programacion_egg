...
public class Ejercicio8_Poo {
    ...
    public static void main(String[] args) {
        ...
        Cadena frase = serv.crearCadena();
        serv.mostrarVocales(frase);
        serv.invertirFrase(frase);
        serv.vecesRepetido(frase);
        serv.compararLongitud(frase);
        serv.unirFrases(frase);
        serv.reemplazar(frase);
        System.out.println(serv.contiene(frase));
    }
