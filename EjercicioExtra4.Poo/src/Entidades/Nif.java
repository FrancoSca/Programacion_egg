...
public class Nif {
    ...
    public String[] getLetra() {
        letra = letras.toUpperCase().split(";");
        return letra;
    }
    ...
    public int getRestDni() {
        return restDni;
    }

    public void setRestDni(int restDni) {
        this.restDni = restDni;
    }
    ...
    public Nif(long Dni, String[] letra, int restDni, String nif) {
        this.Dni = Dni;
        this.letra = letras.split(";");
        this.restDni = restDni;
        this.nif = nif;
    }
