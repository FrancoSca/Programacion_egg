...
public class Sala {
    ...
    private ArrayList<Persona> Espect;
    
    public Sala() {
    }

    public Sala(ArrayList<Asiento> listaAsientos, Pelicula peli, ArrayList<Persona> Espect) {
    ...
    public ArrayList<Persona> getEspect() {
        return Espect;
    }

    public void setEspect(ArrayList<Persona> Espect) {
        this.Espect = Espect;
    }
    ...
    public String toString() {
        return "Sala{" + "listaAsientos=" + listaAsientos + '}';
    }
